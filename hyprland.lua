...
hl.monitor({
    output = "DP-4",
    mode = "2560x1440@60", -- Ajustez le taux de rafraîchissement si nécessaire
    position = "0x0",
    scale = 1
})
...
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("noctalia msg session lock"))    -- Lock la session
...
-- Deplacer une fenetre sur un autre workspace
...
hl.workspace_rule({ workspace = "9", monitor = "DP-4", persistent = true })

-- Fenetre en mode flottante
-- PiP Firefox (Incrustation vidéo)
hl.window_rule({
